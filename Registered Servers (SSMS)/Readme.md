...
- If you haven't used the registered servers before then delete the content of this file ...\Microsoft SQL Server\ *version e.g. 120*\Tools\Shell\RegSrvr.XML on your PC, and add the result.
