...
('Parthasarathi Chinnasamy Velliammal', 'Parthasarathi Chinnasamy Velliammal', 'T24 Team', 1, 'PChinnasamyVelliammal@Bankalbilad.com', 0)
end
go

CREATE TABLE [dbo].[disks]([disk_letter] [varchar](10) NULL, [style] [varchar](10) NULL)
