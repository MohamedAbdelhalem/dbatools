...
/****** Object:  Job [capacity_manager_view]    Script Date: 9/5/2022 1:58:27 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 9/5/2022 1:58:27 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [fill_diks]    Script Date: 9/5/2022 1:58:28 PM ******/
declare
@ip varchar(100), @port varchar(10), @project varchar(300), @cmd nvarchar(max)
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'fill_diks', 
		...
		@proxy_name=N'WinPrx'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [disk_states]    Script Date: 9/5/2022 1:58:28 PM ******/
set @cmd = N'
