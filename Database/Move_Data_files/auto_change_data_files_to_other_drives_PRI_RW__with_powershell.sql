...
@drive_letter_original	varchar(1)	 = 'J',
@drive_letter_new		varchar(1)	 = 'K'
...
when 'copy' then
'PowerShell.exe -Command "& {C:\powerShell\copy_mssql.ps1 -PPathFrom "'+@drive_letter_original+substring(physical_name,2,len(physical_name))+'" -PPathTo "'+@drive_letter_new+substring(physical_name,2,len(physical_name))+'"}"'
when 'alter' then
