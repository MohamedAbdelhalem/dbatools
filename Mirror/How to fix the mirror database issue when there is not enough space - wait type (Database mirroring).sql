...
go
BACKUP log [Database_name] TO  DISK = N'\\BackupPath\Database_name_log_2023_07_25__03_23_pm.bak' WITH NOFORMAT, NOINIT,  
...
FROM DISK = N'\\BackupPath\Database_name_log_2023_07_25__03_23_pm.bak'
WITH FILE = 1,
