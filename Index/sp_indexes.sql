...
if @is_primary_key = 1
begin
set @sql = 'ALTER TABLE '+@p_table_name+' ADD CONSTRAINT ['+@p_index_name+'] PRIMARY KEY '+ case when @P_index_id = 1 then 'CLUSTERED ' else 'NONCLUSTERED ' end + @sql + 
...
set @sql = 'ALTER TABLE '+@p_table_name+' ADD CONSTRAINT ['+@p_index_name+'] UNIQUE '+ case when @P_index_id = 1 then 'CLUSTERED ' else 'NONCLUSTERED ' end + @sql + 
