...
Insert into dbo.auto_restore_job_parameters values ('2023-03-20 00:03:00','T24_support','T24_support',
...
go
declare @team_members varchar(max) = 'Parthasarathi Chinnasamy Velliammal <PChinnasamyVelliammal@Bankalbilad.com>'
...
--6 = 3						without update the metadata
)
as
begin
declare @final_table table (id int identity(1,1), backup_type varchar(100), backup_time_from datetime, backup_time_to datetime, 
