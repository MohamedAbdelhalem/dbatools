use master
go
create procedure ondemand_restore (
...
declare @table_header table (
	...
	col47 varchar(100),col48 varchar(max),col49 varchar(max),col50 varchar(100),col51 varchar(max), --col50 for BackupTypeDescription
