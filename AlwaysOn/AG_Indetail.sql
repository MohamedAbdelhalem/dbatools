...
master.dbo.[virtical_array](replace(replace(replace(ip_configuration_string_from_cluster,'''',''),'(',''),')',''),' ',3) Listener_IP_1,
master.dbo.[virtical_array](replace(replace(replace(ip_configuration_string_from_cluster,'''',''),'(',''),')',''),' ',7) Listener_IP_2
