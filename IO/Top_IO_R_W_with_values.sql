...
[Last Execution], total_logical_writes,total_logical_reads,
...
from (
select top 30
s.text as sql_text,total_logical_reads,total_logical_writes,execution_count,total_physical_reads,
